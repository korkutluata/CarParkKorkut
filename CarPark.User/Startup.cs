...
namespace CarPark.User
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddLocalization(opt => { opt.ResourcesPath = "Resources"; });  // Localization'ı projeye dahil etmiş olduk. Web'de kullanılacağı için dil , Resources klasörünü CarPark.User'da açtık

            services.AddMvc()
                .AddViewLocalization()   // view'de localization kullanılabilmesi için eklenmesi gerekli
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // yukarıda tanımladığımız localizationları kullanmak için Configure içinde ...
